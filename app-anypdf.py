...
class GeminiPDFChatbot:
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            st.write("This chat bot uses the [Gemini Pro model](https://blog.google/technology/ai/google-gemini-next-generation-model-february-2024/) to answer questions about uploaded PDFs.")
            st.write("__DISCLAIMER:__ *The responses in this chat bot are generated by a generative artificial intelligence large language model. Please note that the information provided may by completely incorrect. You cannot rely upon the provided answers and we accept no liability if you get incorrect answers or responses. Again, we do not assume any responsibility or liability for the use or interpretation of this content.*")
